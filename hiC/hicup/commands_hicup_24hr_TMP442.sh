...
REP="TMP442" # change
PROMOTEROME_DIR="naiveT_24hr_"$REP # change
FASTQ_R1="naiveT_24hr_"$REP"_R1.fastq.gz" # change
FASTQ_R2="naiveT_24hr_"$REP"_R2.fastq.gz" # change
RAWDATA_DIR="/mnt/isilon/sfgi/rawData/wells/hiC/PMBC_naiveT_stim/naiveT_24hr/naiveT_24hr_"$REP  # change

dir="/mnt/isilon/sfgi/suc1/analyses/wells/hiC/chicago" # change
chicago_run="naiveT_24hr_2reps" # change
...
hicup_dir="/mnt/isilon/sfgi/suc1/analyses/wells/hiC/hicup" # change
hicup_names=("naiveT_24hr_ND517" "naiveT_24hr_TMP442") # change
...
" > merge_ibed.sh
qsub -cwd -l h_vmem=8G merge_ibed.sh
...
webserver_dir="/var/www/html/ucsc/sfgi/suc1/wells/hiC/chicago/naiveT_stim"  # change

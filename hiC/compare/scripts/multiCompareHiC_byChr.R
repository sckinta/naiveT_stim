...
# dir="/mnt/isilon/sfgi/suc1/analyses/wells/hiC/compare/naiveT_stim/data/4000/chr1"
# out_prefix="/mnt/isilon/sfgi/suc1/analyses/wells/hiC/compare/naiveT_stim/data/4000/chr1/HiCcompare"
# numCores=1
...
my.contrasts <- makeContrasts(
        hr24_vs_unstim=groups0-groups2,
        hr8_vs_unstim=groups1-groups2,
        hr24_vs_hr8=groups0-groups1,
        levels=design
)

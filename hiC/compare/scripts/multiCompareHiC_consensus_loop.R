...
dir="/mnt/isilon/sfgi/suc1/analyses/wells/hiC/compare/naiveT_stim"
juicer_dir="/mnt/isilon/sfgi/suc1/analyses/wells/hiC/juicer/naiveT_stim_summary"

resols=c("1000","2000","4000")
comparisons=c("hr8_vs_unstim","hr24_vs_unstim","hr24_vs_hr8")

#################### sigDE_consensus_loop ###########################
extract_sigDE_consensus_loop <- function(resol, comp){
        consensus_loop=vroom::vroom(
                file.path(juicer_dir,paste0("naiveT_all.res",resol,".bedpe")),
...
data(prom_bed)
ocr_bed = vroom::vroom(
        "/mnt/isilon/sfgi/suc1/analyses/wells/atacSeq/PBMC_naiveT/peaks/mergeCondition_pooledRep/all.filtered_newName.bed",

...
REP="rep3" # change
PROMOTEROME_DIR="Jurkat_4hr_"$REP # change
FASTQ_R1="Jurkat_4hr_"$REP"_R1.fastq.gz" # change
FASTQ_R2="Jurkat_4hr_"$REP"_R2.fastq.gz" # change
RAWDATA_DIR="/mnt/isilon/sfgi/rawData/wells/captureC/Jurkat/Jurkat_4hr/Jurkat_4hr_"$REP  # change

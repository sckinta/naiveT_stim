...
REP="rep3" # change
PROMOTEROME_DIR="Jurkat_unstim_"$REP # change
FASTQ_R1="Jurkat_unstim_"$REP"_R1.fastq.gz" # change
FASTQ_R2="Jurkat_unstim_"$REP"_R2.fastq.gz" # change
RAWDATA_DIR="/mnt/isilon/sfgi/rawData/wells/captureC/Jurkat/Jurkat_unstim/Jurkat_unstim_"$REP  # change
